                ...
                {sectionFields.map((section, sectionIndex) => (
                    <div className='section' key={section.id}>
                        ...
                        <div className="sectionsList">
                            <SectionFields errors={errors} control={control} sectionIndex={sectionIndex} section={section} />
                        </div>
                    </div>
                ))}
                <div className="actions">
                    <button type="button" onClick={() => appendSection({ title: '', fields: [{ label: '', register_key: '', view_Type: '', field_Type: '', values: [{ label: '', value: '', iconURL: '' }] }] })}>Add Section</button>
